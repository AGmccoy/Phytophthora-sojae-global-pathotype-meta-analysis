...
library(vegan) #v2.5-7 (will need to go back to v2.4-3 for 'adonis' functionality in RVAideMemoire's "pairwise.perm.manova.()" code. Currently throws error in pairwise permanova since adonis() has been depreciated for adonis2() in vegan. However, the analysis has already been done.
library(ape) #v5.2-6
...
USA_isolate_complexity_metadata_1isoperline <- unique(USA_isolate_complexity_metadata)

USA_timepoints_mean_complexity <- USA_isolate_complexity_metadata_1isoperline %>%
  group_by(time_point) %>%
  mutate() %>%
  summarize(mean_comp=mean(path_comp),
            sd_comp=sd(path_comp),
...
USA_complexity_box <- ggplot(USA_isolate_complexity_metadata_1isoperline, aes(x=time_point, y=path_comp, fill = time_point)) +
  geom_boxplot() +
...
USA_complexity_data_90_99_00_13 <- USA_isolate_complexity_metadata_1isoperline %>%
...
USA_complexity_data_90_99_14_19 <- USA_isolate_complexity_metadata_1isoperline %>%
...
USA_complexity_data_00_13_14_19 <- USA_isolate_complexity_metadata_1isoperline %>%
...
ARG_isolate_complexity_metadata_1isoperline <- unique(ARG_isolate_complexity_metadata) 

ARG_timepoints_mean_complexity <- ARG_isolate_complexity_metadata_1isoperline %>%
  group_by(time_point) %>%
  mutate() %>%
  summarize(mean_comp=mean(path_comp),
            sd_comp=sd(path_comp),
...
# Lets look at this data using a boxplot
ARG_complexity_box <- ggplot(ARG_isolate_complexity_metadata_1isoperline, aes(x=time_point, y=path_comp, fill = time_point)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#99CCFF", "#808080", "#FF9999")) +
  coord_flip() +
  theme_gray() +
...
ARG_complexity_data_89_99_00_12 <- ARG_isolate_complexity_metadata_1isoperline %>%
  subset(time_point!="2013_2019")
...
ARG_complexity_data_89_99_13_19 <- ARG_isolate_complexity_metadata_1isoperline %>%
...
ARG_complexity_data_00_12_13_19 <- ARG_isolate_complexity_metadata_1isoperline %>%
...
CAN_isolate_complexity_metadata_1isoperline <- unique(CAN_isolate_complexity_metadata)

CAN_timepoints_mean_complexity <- CAN_isolate_complexity_metadata_1isoperline %>%
  group_by(time_point) %>%
  mutate() %>%
  summarize(mean_comp=mean(path_comp),
            sd_comp=sd(path_comp),
...
# Lets look at this data using a boxplot
CAN_complexity_box <- ggplot(CAN_isolate_complexity_metadata_1isoperline, aes(x=time_point, y=path_comp, fill = time_point)) +
  geom_boxplot() +
...
# between 2000-2013 and 2014-2019 timepoints
CAN_complexity_data_00_13_14_19 <- CAN_isolate_complexity_metadata_1isoperline %>%
  subset(time_point!="1990_1999")
...
CHI_isolate_complexity_metadata_1isoperline <- unique(CHI_isolate_complexity_metadata)

CHI_timepoints_mean_complexity <- CHI_isolate_complexity_metadata_1isoperline %>%
  group_by(time_point) %>%
  mutate() %>%
  summarize(mean_comp=mean(path_comp),
            sd_comp=sd(path_comp),
...
# Lets look at this data using a boxplot
CHI_complexity_box <- ggplot(CHI_isolate_complexity_metadata_1isoperline, aes(x=time_point, y=path_comp, fill = time_point)) +
  geom_boxplot() +
...
# between 1990-1999 and 2000-2013 timepoints
CHI_complexity_data_90_99_00_13 <- CHI_isolate_complexity_metadata_1isoperline %>%
  subset(time_point!="2014_2019")
...
USA_rps_eff_tim <- ggplot(USA_timepoint_study_gene_summary, aes(x=time_point, y=perc_pathogenic, fill=time_point)) + 
  ...
  theme(axis.text.x = element_blank(),
                     ...
                     title = element_text(size = 25, family = "serif")) +
  ylim(0,100) +
                  labs(x="Time Frame",y="Percent Isolates Pathogenic", fill="Time Frame") +
          ggtitle("USA") 
...
ARG_rps_eff_tim <- ggplot(ARG_timepoint_study_gene_summary, aes(x=time_point, y=perc_pathogenic, fill=time_point)) +
geom_violin(scale="width", size=0.1, position = position_dodge(width = 1.0), trim=FALSE) + #position = 'dodge', col = '#4d4d4d'
  #geom_jitter(shape=16, size=1, position = position_jitter(0.5), alpha=0.5) + 
  geom_point(position=position_jitterdodge(jitter.width = 0.1), alpha=0.5) +
  stat_summary(fun = "mean", geom="crossbar", width= 0.5, colour="black") +
...
CAN_rps_eff_tim <- ggplot(CAN_timepoint_study_gene_summary, aes(x=time_point, y=perc_pathogenic, fill=time_point)) +
geom_violin(scale="width", size=0.1, position = position_dodge(width = 1.0), trim=FALSE) + #position = 'dodge', col = '#4d4d4d'
  #geom_jitter(shape=16, size=1, position = position_jitter(0.5), alpha=0.5) + 
  geom_point(position=position_jitterdodge(jitter.width = 0.1), alpha=0.5) +
  stat_summary(fun = "mean", geom="crossbar", width= 0.5, colour="black") +
...
CHI_rps_eff_tim <- ggplot(CHI_timepoint_study_gene_summary, aes(time_point, perc_pathogenic, fill=time_point)) +
geom_violin(scale="width", size=0.1, position = position_dodge(width = 1.0), trim=FALSE) + #position = 'dodge', col = '#4d4d4d'
  #geom_jitter(shape=16, size=1, position = position_jitter(0.5), alpha=0.5) + 
  geom_point(position=position_jitterdodge(jitter.width = 0.1), alpha=0.5) +
  stat_summary(fun = "mean", geom="crossbar", width= 0.5, colour="black") +
...
ggsave("combined pathotype combined gene efficacy temporal violin plots.png", plot=combined_gene_eff_temporal, width=20, height=16, dpi = 600)
```
...
USA_patho_pair_perma <- pairwise.perm.manova(USA_vir_jaccard, USA_groups, nperm = 999, R2=TRUE)
...
Map of isolate locations
```{r}
USA_final_data # This data contains which states were sampled within The United States

USA_48_map <- here(
  "PoliticalBoundaries_Shapefile", # this is the path to the ".shp" file
  ...
  st_read() %>%
  subset(., COUNTRY!="MEX") %>% # removing Mexico location data as it is not needed
  subset(., COUNTRY!="CAN") %>% # Removing canada data as we will plot it seperately in the next map
  filter(!(NAME_En %in% c("Alaska", "Hawaii", "Puerto Rico")))

tf_1990_1999 <- USA_48_map %>%
  filter(NAME_En %in% c("Arkansas", "Ohio", "Iowa", "Indiana", "Michigan"))

tf_2000_2013 <- USA_48_map %>%
  filter(NAME_En %in% c("North Dakota", "Kansas", "Minnesota", "Missouri", "New York", "Ohio", "Iowa", "Indiana", "Michigan", "Illinois", "Nebraska", "South Dakota"))

tf_2013_2019 <- USA_48_map %>%
  filter(NAME_En %in% c("Kentucky", "Ohio", "Iowa", "Indiana", "Michigan", "Illinois", "Nebraska", "South Dakota"))

#tf_2000_2013_and_2013_2019 <- USA_48_map %>%
 # filter(NAME_En %in% c("Illinois", "Nebraska", "South Dakota"))

#tf_across_timeframes <- USA_48_map %>%
 # filter(NAME_En %in% c("Ohio", "Iowa", "Indiana", "Michigan"))
  
#c("#99CCFF", "#808080", "#FF9999")

sf_use_s2(FALSE)

USA_1990_1999_map <- ggplot() +
  geom_sf(data = USA_48_map) +
  geom_sf(data = tf_1990_1999, mapping = aes(fill="#99CCFF"), show.legend = TRUE) +
  #geom_sf(data = tf_2000_2013, mapping = aes(fill="#808080"), show.legend = TRUE) +
  #geom_sf(data = tf_2013_2019, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  #geom_sf(data = tf_2000_2013_and_2013_2019, mapping = aes(fill="#FFD700"), show.legend = TRUE) +
  #geom_sf(data = tf_across_timeframes, mapping = aes(fill="#BF3EFF"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("USA 1990-1999 state sampling")

USA_1990_1999_map

USA_2000_2013_map <- ggplot() +
  geom_sf(data = USA_48_map) +
  #geom_sf(data = tf_1990_1999, mapping = aes(fill="#99CCFF"), show.legend = FALSE) +
  geom_sf(data = tf_2000_2013, mapping = aes(fill="#808080"), show.legend = TRUE) +
  #geom_sf(data = tf_2013_2019, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  #geom_sf(data = tf_2000_2013_and_2013_2019, mapping = aes(fill="#FFD700"), show.legend = TRUE) +
  #geom_sf(data = tf_across_timeframes, mapping = aes(fill="#BF3EFF"), show.legend = TRUE) +
  ...
  scale_fill_identity() +
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("USA 2000-2013 state sampling")

USA_2000_2013_map

USA_2013_2019_map <- ggplot() +
  geom_sf(data = USA_48_map) +
  #geom_sf(data = tf_1990_1999, mapping = aes(fill="#99CCFF"), show.legend = FALSE) +
  #geom_sf(data = tf_2000_2013, mapping = aes(fill="#808080"), show.legend = FALSE) +
  geom_sf(data = tf_2013_2019, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  #geom_sf(data = tf_2000_2013_and_2013_2019, mapping = aes(fill="#FFD700"), show.legend = TRUE) +
  #geom_sf(data = tf_across_timeframes, mapping = aes(fill="#BF3EFF"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("USA 2013-2019 state sampling")

USA_2013_2019_map

combined_state_sampling <- plot_grid(USA_1990_1999_map,USA_2000_2013_map, USA_2013_2019_map, ncol=3)
combined_state_sampling

#ggsave("USA State Sampling over time.png", plot=combined_state_sampling, width=20, height=16, dpi = 600)

```

CAN map
```{r}
CAN_final_data # This data contains which states were sampled within Canada
...
tf_2000_2013_CAN <- CAN_map %>%
  filter(NAME_En %in% c("Ontario"))

tf_2014_2019_CAN <- CAN_map %>%
  filter(NAME_En %in% c("Manitoba", "Quebec", "Ontario"))
  
CAN_2000_2013 <- ggplot() +
  geom_sf(data = CAN_map) +
  geom_sf(data = tf_2000_2013_CAN, mapping = aes(fill="#808080"), show.legend = TRUE) +
  #geom_sf(data = tf_2014_2019_CAN, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    theme(axis.text.x = element_text(size = 10, face = "bold", family = "serif"),
    axis.text.y = element_text(size = 10, face = "bold", family = "serif"),
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("Canada 2000-2013 state sampling")

CAN_2000_2013

CAN_2014_2019 <- ggplot() +
  geom_sf(data = CAN_map) +
  #geom_sf(data = tf_2000_2013_CAN, mapping = aes(fill="#808080"), show.legend = TRUE) +
  geom_sf(data = tf_2014_2019_CAN, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("Canada 2014-2019 state sampling")

CAN_2014_2019

combined_provence_sampling_CAN <- plot_grid(CAN_2000_2013, CAN_2014_2019, ncol=2)
combined_provence_sampling_CAN

#ggsave("CAN State Sampling over time.png", plot=combined_provence_sampling_CAN, width=20, height=16, dpi = 600)

```

Argentina map of sampling
```{r}
ARG_final_data # This data contains which states were sampled within Canada


ARG_map <- here("argentina shapefiles",
                "arg_admbnda_adm1_unhcr2017.shp") %>%
  st_read() 

tf_1989_1999_ARG <- ARG_map %>%
  filter(ADM1_ES %in% c("Buenos Aires", "Entre Ríos", "Córdoba", "Santa Fe"))

tf_2000_2013_ARG <- ARG_map %>%
  filter(ADM1_ES %in% c("Buenos Aires", "Entre Ríos", "Córdoba", "Santa Fe"))

tf_2014_2019_ARG <- ARG_map %>%
  filter(ADM1_ES %in% c("Buenos Aires", "Entre Ríos"))
  
ARG_1989_1999 <- ggplot() +
  geom_sf(data = ARG_map) +
  geom_sf(data = tf_1989_1999_ARG, mapping = aes(fill="#99CCFF"), show.legend = TRUE) +
  #geom_sf(data = tf_2000_2013_ARG, mapping = aes(fill="#808080"), show.legend = FALSE) +
  #geom_sf(data = tf_2014_2019_ARG, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    theme(axis.text.x = element_text(size = 10, face = "bold", family = "serif"),
    axis.text.y = element_text(size = 10, face = "bold", family = "serif"),
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("Argentina 1989-1999 state sampling")

ARG_1989_1999

ARG_2000_2013 <- ggplot() +
  geom_sf(data = ARG_map) +
  #geom_sf(data = tf_1989_1999_ARG, mapping = aes(fill="#99CCFF"), show.legend = FALSE) +
  geom_sf(data = tf_2000_2013_ARG, mapping = aes(fill="#808080"), show.legend = TRUE) +
  #geom_sf(data = tf_2014_2019_ARG, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    theme(axis.text.x = element_text(size = 10, face = "bold", family = "serif"),
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("Argentina 2000-2013 state sampling")

ARG_2000_2013

ARG_2014_2019 <- ggplot() +
  geom_sf(data = ARG_map) +
  #geom_sf(data = tf_1989_1999_ARG, mapping = aes(fill="#99CCFF"), show.legend = FALSE) +
  #geom_sf(data = tf_2000_2013_ARG, mapping = aes(fill="#808080"), show.legend = FALSE) +
  geom_sf(data = tf_2014_2019_ARG, mapping = aes(fill="#FF9999"), show.legend = TRUE) +
  ...
  scale_fill_identity() +
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("Argentina 2014-2019 state sampling")

ARG_2014_2019

combined_provence_sampling_ARG <- plot_grid(ARG_1989_1999, ARG_2000_2013, ARG_2014_2019, ncol=3)
combined_provence_sampling_ARG

ggsave("ARG State Sampling over time.png", plot=combined_provence_sampling_ARG, width=20, height=16, dpi = 600)

```
China
```{r}
CHI_map <- here("china shapefiles",
                "chn_admbnda_adm1_ocha_2020.shp") %>%
  st_read() %>%
  subset(., ADM1_EN !="Taiwan Province")

tf_1990_1999_CHI <-  CHI_map %>%
  filter(ADM1_EN %in% c("Heilongjiang Province", "Jilin Province", "Inner Mongolia Autonomous Region", "Anhui Province"))

tf_2000_2013_CHI <- CHI_map %>%
  filter(ADM1_EN %in% c("Anhui Province", "Henan Province", "Shandong Province", "Jiangsu Province", "Zhejiang Province", "Jilin Province", "Heilongjiang Province", "Fujian Province", "Xinjiang Uygur Autonomous Region"))

China_1990_1999_map <- ggplot() +
  geom_sf(data = CHI_map) +
  geom_sf(data = tf_1990_1999_CHI, mapping = aes(fill="#99CCFF"), show.legend = TRUE) +
  #geom_sf(data = tf_2000_2013_CHI, mapping = aes(fill="#808080"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    theme(axis.text.x = element_text(size = 10, face = "bold", family = "serif"),
    axis.text.y = element_text(size = 10, face = "bold", family = "serif"),
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("China 1990 - 1999 provincial sampling")

China_1990_1999_map

China_2000_2013_map <- ggplot() +
  geom_sf(data = CHI_map) +
  #geom_sf(data = tf_1990_1999_CHI, mapping = aes(fill="#99CCFF"), show.legend = TRUE) +
  geom_sf(data = tf_2000_2013_CHI, mapping = aes(fill="#808080"), show.legend = TRUE) +
  coord_sf() +
  scale_fill_identity() +
    ...
    title = element_text(size = 10, family = "serif")) +
     xlab("Longitude") + ylab("Latitude") +
      ggtitle("China 2000 - 2013 provincial sampling")

China_2000_2013_map

combined_provence_sampling_CHI <- plot_grid(China_1990_1999_map, China_2000_2013_map, ncol=2)
combined_provence_sampling_CHI

ggsave("CHI provincial Sampling over time.png", plot=combined_provence_sampling_CHI, width=20, height=16, dpi = 600)
```
temporary plotting all maps together
```{r}
all_temporal_sample_locations <- plot_grid(combined_state_sampling, combined_provence_sampling_CAN, combined_provence_sampling_ARG, nrow = 3)

all_temporal_sample_locations

ggsave("All countries State Sampling over time.png", plot=all_temporal_sample_locations, width=20, height=16, dpi = 600)
