...
USA_RPS_overtime <- ggplot(USA_timepoint_study_gene_summary, aes(x=as.numeric(factor(year)),y=perc_pathogenic)) +
  facet_wrap(vars(Rps)) +
  ...
  theme(axis.text.x = element_blank(),
                  ...
                  #xlim(1,3)  +
                  ylim(0,100) +
                  labs(x="Time Point",y="Percent Isolates Pathogenic", col="Time Point")
...
ARG_RPS_overtime <-ggplot(ARG_timepoint_study_gene_summary, aes(x=as.numeric(factor(year)),y=perc_pathogenic)) +
  facet_wrap(vars(Rps)) +
  geom_point(aes(colour = factor(time_point))) +
  geom_smooth(method=lm) +
  geom_hline(yintercept=40, linetype="dashed", color = "red") +
...
CAN_RPS_overtime <-ggplot(CAN_timepoint_study_gene_summary, aes(x=as.numeric(factor(year)),y=perc_pathogenic)) +
  facet_wrap(vars(Rps)) +
  geom_point(aes(colour = factor(time_point))) +
  geom_smooth(method=lm) +
  geom_hline(yintercept=40, linetype="dashed", color = "red") +
...
CHI_RPS_overtime <-ggplot(CHI_timepoint_study_gene_summary, aes(x=as.numeric(factor(year)),y=perc_pathogenic)) +
  facet_wrap(vars(Rps)) +
  geom_point(aes(colour = factor(time_point))) +
  geom_smooth(method=lm) +
  geom_hline(yintercept=40, linetype="dashed", color = "red") +
