...
#renv::install("hagis@3.1.2.9000")
#renv::install("pander@0.6.4")
#renv::install("vegan@2.4-3")
#renv::install("ape@5.3") #closest to 5.2-6 I can get, previously used 5.6-2
#renv::install("ggsigniff@0.6.3")
...
#renv::install("RVAideMemoire@0.9-81-2")
...
USA_patho_pair_perma <- pairwise.perm.manova(as.matrix(t_USA_vir_jaccard), USA_groups, test= c("Wilks"), nperm = 99, progress = TRUE, R2=TRUE)
